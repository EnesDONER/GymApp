...
export class MovementService {
  ...
  update(model: FormData, callBack: (res:SingleResponseModel<MovementModel>)=> void){
    this._http.post<SingleResponseModel<MovementModel>>("movement/update", model, res=> callBack(res));
  }
